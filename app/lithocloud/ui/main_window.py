...
from lithocloud.core import Project, discover_engines, scan_project
...
#: The repo root (…/LithoCloud), where engines/ lives.
...
class MainWindow(QMainWindow):
    def __init__(
        ...
        *,
        ...
        self.setWindowTitle("LithoCloud - {0}".format(project.name))
    ...
    def _build_menu(self) -> None:
        ...
        about_action = help_menu.addAction("&About LithoCloud")
